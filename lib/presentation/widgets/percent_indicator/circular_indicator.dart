...
//
//   @override
//   _CircularHalfIndicatorState createState() => _CircularHalfIndicatorState();
// }
//
// class _CircularHalfIndicatorState extends State<CircularHalfIndicator>
...
//   }
//
//   void _checkIfNeedCancelAnimation(CircularHalfIndicator oldWidget) {
...
//
//   @override
//   void didUpdateWidget(CircularHalfIndicator oldWidget) {
...
//     //       endAngle: clipRotatedLinearGradient ? radians(360).toDouble() : radians(progress).toDouble(),
...
//       );
//     } else {
//       final start = radians(-90 + fixedStartAngle).toDouble();
//       final end = radians(progress * startAngleFixedMargin).toDouble();
//       if (progressBorderColor != null) {
//         canvas.drawArc(
//           Rect.fromCircle(
